...
parser.add_argument('--path', type=str, default=["./data/VehicleX/ReID Task/query/",
                                                "./data/VehicleX/ReID Task/fake_images/"])
    ...
    for i in range(n_batches):
        ...
        for f in files[start:end]:
            ...
            with Image.open(str(f)) as img:
                ...
                # Convert image to numpy array and specify the data type
...
def calculate_fd_given_paths(paths):
